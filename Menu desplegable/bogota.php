...
<html>
    ...
    <body>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300&display=swap" rel="stylesheet">
        ...
        <main id="mainbogota">
           <img src="img/Bogota.jpg" alt="" id="img2">
            <article>
                <p class="argumento">
              De padre armenio y madre española, nació en Beirut, Líbano, en 1975, pero con apenas tres años, él y su familia tuvieron que emigrar al país ibérico debido a la Guerra Civil Libanesa. Habiendo practicado siempre diferentes deportes, en 1999 empezó su carrera como boxeador profesional, llegando un récord de 16 victorias y 1 derrota.
                </p>

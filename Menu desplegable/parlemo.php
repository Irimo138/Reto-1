...
<html>
    ...
    <body>
     ...
     <nav id="header">
        ...
        <main>
           <img src="img/parlemo.jpg" alt="" id="img2">
            <article>
                <p class="argumento">
                       Martín Berrote, también conocido como Palermo es el atracador a cargo del atraco hecho al Banco Nacional de España. Tras decisiones que hizo, Tokio le quitó el mando hasta que volvió a integrarse al equipo.
                </p>

...
<html>
    ...
    <body>
     ...
     <nav id="header">
        ...
        <main id="mainmarsella">
           <img src="img/marsella.jfif" alt="" id="img2">
            <article>
                <p class="argumento">
               Marsella es un hombre parco en palabras, sufrió las guerras de los Balcanes en su propia piel y lo único positivo que sacó aquella experiencia es que ahora se gana la vida haciendo el trabajo sucio que nadie quiere hacer.
                </p>

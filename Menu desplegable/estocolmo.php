...
<html>
    ...
    <body>
     ...
     <nav id="header">
        ...
        <main id="mainestocolmo">
           <img src="img/estocolmo.jpg" alt="" id="img2">
            <article>
                <p class="argumento">
              Mónica Gaztambide es de esas mujeres que se fija siempre en el hombre equivocado en el peor momento posible. Tras varios fracasos en la oposiciones a funcionario de alto rango, Mónica logró aprobar el examen que le permitía ejercer como secretaria del Director de la Fábrica Nacional de Moneda y Timbre, a la sazón, Arturo, el hombre que
le trae por la calle de la amargura. Casado y con tres hijos, lleva tiempo, desde que se liaron prácticamente, dándole largas y beneficiándose de la situación.
                </p>
